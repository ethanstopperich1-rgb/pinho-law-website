...
const { generateMetadata, Page } = makePlaceholderRoute({
  ...
  descriptions: {
    pt: "Best Lawyers 4× (2021–2026), Orlando Magazine Mulher do Ano 2022, Orlando Business Journal 40 Under 40 2023, e mais 11 reconhecimentos.",
    en: "Best Lawyers 4× (2021–2026), Orlando Magazine Woman of the Year 2022, Orlando Business Journal 40 Under 40 2023, and 11 more honors.",
