...
const COPY = {
  pt: {
    ...
    related: [
      ...
      { label: "O-1A como alternativa não-imigrante", href: "/immigration/non-immigrant-visas/o-1" },
  ...
  en: {
    ...
    related: [
      ...
      { label: "EB-2 with PERM (employer-sponsored)", href: "/immigration/immigrant-visas/eb-2" },
      { label: "EB-1 — Extraordinary Ability", href: "/immigration/immigrant-visas/eb-1" },
      { label: "O-1A as a non-immigrant alternative", href: "/immigration/non-immigrant-visas/o-1" },
  ...
  es: {
    ...
    relatedTitle: "Relacionado",
    related: [
      { label: "EB-2 NIW para profesionales de Tech", href: "/immigration/immigrant-visas/eb-2-niw/for-tech-professionals" },
      { label: "EB-2 NIW para Médicos", href: "/immigration/immigrant-visas/eb-2-niw/for-doctors" },
      { label: "EB-2 NIW vs EB-1A — cuál elegir", href: "/immigration/immigrant-visas/eb-2-niw/vs-eb-1a" },
      { label: "EB-2 con PERM (alternativa con empleador)", href: "/immigration/immigrant-visas/eb-2" },
