 ...
 *
 * Renders a solid, undulating mountain landscape using a custom
 * Perlin-noise shader. Mouse movement drives the point light's
 * position, producing a parallax lighting effect across the ridge.
 *
 * Side effects: requestAnimationFrame loop + window resize/mousemove
...
export function GenerativeMountainScene() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Keep lightY in play — touches the light's intensity falloff
      // via its Y coord on the positional vector we build above.
      void lightY;
